 ...
 */
@NonNullByDefault
public class PartitionLabel extends RiscoMessage {
    public static final String COMMAND = "PLBL";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public PartitionLabel(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
