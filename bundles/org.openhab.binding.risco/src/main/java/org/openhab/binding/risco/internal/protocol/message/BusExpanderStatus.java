 ...
 */
@NonNullByDefault
public class BusExpanderStatus extends RiscoMessage {
    public static final String COMMAND = "BESTT";
    ...
    public BusExpanderStatus(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
