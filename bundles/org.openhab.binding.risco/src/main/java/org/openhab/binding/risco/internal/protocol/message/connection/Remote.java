 ...
 */
package org.openhab.binding.risco.internal.protocol.message.connection;
 ...
 */
@NonNullByDefault
public class Remote extends RiscoMessage {
    public static final String COMMAND = "RMT";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public Remote(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
    ...
    public static String getReadCommand(String password) {
        return String.format(COMMAND + "=%s", password);
    }
}
