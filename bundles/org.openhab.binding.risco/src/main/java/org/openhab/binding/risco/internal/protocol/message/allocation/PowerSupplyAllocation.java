 ...
 */
@NonNullByDefault
public class PowerSupplyAllocation extends RiscoMessage {
    public static final String COMMAND = "PSALOC&";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public PowerSupplyAllocation(int commandId, String commandName, String modifier, String[] commandValues,
