 ...
 */
@NonNullByDefault
public class ProximityReaderAllocation extends RiscoMessage {
    public static final String COMMAND = "KRALOC&";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public ProximityReaderAllocation(int commandId, String commandName, String modifier, String[] commandValues,
