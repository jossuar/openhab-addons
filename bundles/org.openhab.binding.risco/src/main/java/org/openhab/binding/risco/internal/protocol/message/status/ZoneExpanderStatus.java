 ...
 */
@NonNullByDefault
public class ZoneExpanderStatus extends RiscoMessage {
    public static final String COMMAND = "ZESTT";

    // @formatter:off
    private final StatusProperty[] properties = {
            new StatusProperty("tamper", "T"),
            new StatusProperty("communication-trouble", "C"),
            new StatusProperty("aux-trouble", "A"),
            new StatusProperty("exists", "E") };
    // @formatter:on

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public ZoneExpanderStatus(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
