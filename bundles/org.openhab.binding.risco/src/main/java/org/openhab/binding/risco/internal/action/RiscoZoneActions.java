...
public class RiscoZoneActions implements ThingActions {
    ...
    private @Nullable RiscoZoneHandler handler;

    @Override
    public void setThingHandler(@Nullable ThingHandler handler) {
        if (handler instanceof RiscoZoneHandler zoneHandler) {
    ...
    public void bypass() {
        // Check of parameters
        RiscoZoneHandler thingHandler = this.handler;
    ...
    public static void bypass(ThingActions actions) {
        ((RiscoZoneActions) actions).bypass();
    }
}
