 ...
 */
@NonNullByDefault
public class Local extends RiscoMessage {
    public static final String COMMAND = "LCL";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public Local(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom, int indexTo,
            byte[] encryptedMessage, byte[] decryptedMessage) {
