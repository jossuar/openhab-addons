 ...
 */
@NonNullByDefault
public class OutputExpanderAllocation extends RiscoMessage {
    public static final String COMMAND = "UOALOC&";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public OutputExpanderAllocation(int commandId, String commandName, String modifier, String[] commandValues,
