 ...
 */
@NonNullByDefault
public class PartitionDisarm extends RiscoMessage {
    public static final String COMMAND = "DISARM";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public PartitionDisarm(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
    ...
    public static String getCommand(int partitionNumber) {
