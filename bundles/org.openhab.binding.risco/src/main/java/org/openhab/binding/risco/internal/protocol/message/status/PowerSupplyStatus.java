 ...
 */
@NonNullByDefault
public class PowerSupplyStatus extends RiscoMessage {
    public static final String COMMAND = "PSSTT";
    ...
    private final StatusProperty[] properties = {
            ...
            new StatusProperty("low-battery", "L"),
            new StatusProperty("aux-trouble", "X"),
            new StatusProperty("bell-trouble", "B"),
            new StatusProperty("exists", "E") };
    // @formatter:on

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public PowerSupplyStatus(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
    ...
    public static String getReadCommand(int powerSupplyNumber) {
        return String.format(COMMAND + "%d?", powerSupplyNumber);
    }
}
