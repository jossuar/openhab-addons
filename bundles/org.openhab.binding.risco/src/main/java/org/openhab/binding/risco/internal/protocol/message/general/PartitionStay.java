 ...
 */
@NonNullByDefault
public class PartitionStay extends RiscoMessage {
    public static final String COMMAND = "STAY";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public PartitionStay(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
