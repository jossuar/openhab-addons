 ...
 */
@NonNullByDefault
public class ProximityReaderStatus extends RiscoMessage {
    ...
    public ProximityReaderStatus(int commandId, String commandName, String modifier, String[] commandValues,
    ...
    public static String getReadCommand(int proximityReaderNumber) {
        return String.format(COMMAND + "%d?", proximityReaderNumber);
    }
}
