 ...
 */
@NonNullByDefault
public class UserPin extends RiscoMessage {
    public static final String COMMAND = "UPIN";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public UserPin(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
    ...
    public List<RiscoThing> getThings() {
        if (messageThings.isEmpty() && commandValues.length > 0) {
            ...
            props.add(new RiscoProperty("pin", commandValues[0]));
