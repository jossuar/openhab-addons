 ...
 */
@NonNullByDefault
public class ZoneBypass extends RiscoMessage {
    public static final String COMMAND = "ZBYPAS";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public ZoneBypass(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
    ...
    public static String getCommand(int zoneNumber) {
