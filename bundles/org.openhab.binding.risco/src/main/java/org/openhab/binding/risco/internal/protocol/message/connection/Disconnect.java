 ...
 */
@NonNullByDefault
public class Disconnect extends RiscoMessage {
    public static final String COMMAND = "DCN";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public Disconnect(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
