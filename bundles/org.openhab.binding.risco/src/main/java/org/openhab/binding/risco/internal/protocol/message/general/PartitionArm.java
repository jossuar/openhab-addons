 ...
 */
@NonNullByDefault
public class PartitionArm extends RiscoMessage {
    public static final String COMMAND = "ARM";

    private List<RiscoThing> messageThings = new ArrayList<RiscoThing>();

    public PartitionArm(int commandId, String commandName, String modifier, String[] commandValues, int indexFrom,
